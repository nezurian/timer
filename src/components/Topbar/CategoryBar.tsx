...
export default function CategoryBar() {
    ...
    // Hovering a single category displays the name and the color on the top bar.
    ...
    return (
        <div
            ...
            className={`rounded-lg  justify-around relative ${BGcolor} ${BorderColor} cursor-pointer transition duration-300 ease-in no-outline w-64 border w-1/4 antialiased text-center text-gray-800`}
        >
            {category.title}
